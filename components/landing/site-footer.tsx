      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-8 px-5 py-12 sm:flex-row sm:items-end sm:justify-between sm:px-8">
        ...
        <div className="flex flex-col gap-2 text-sm sm:items-end">
          ...
          <Link
            ...
            className="mt-2 inline-flex size-8 items-center justify-center self-start rounded-full border border-line text-[10px] tracking-[0.1em] text-muted transition-colors hover:border-white/30 hover:text-ink sm:self-end"
          >
            ·
          </Link>
        </div>
